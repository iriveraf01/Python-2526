...
#CORRECCION: Poner enumerate(lector, start=2) porque la primera fila es la cabecera
                for fila in lector:
                    convertido = RegistroTemperatura.desde_dict(fila)
                    self.registros.append(convertido)
                    #CORRECCION: Falta sumar al atributo de clase
                    #CORRECCION: Poner un contador, porque si registros tiene 10 registros ya añades 3
                    #debería aparecer que has cargado 3 no 13.
